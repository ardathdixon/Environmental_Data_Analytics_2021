...
Nutr_PeterPaul <- read.csv('./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv')
Nutr_PeterPaul_tidy <- read.csv('./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv')
