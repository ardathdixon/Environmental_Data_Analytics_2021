...
AQIlat <- ggplot(EPAair, aes(x=Ozone, y=PM2.5, color=meanLat))+
...
PM2.5year_1 <- ggplot(EPAair, aes(x=Year, y=PM2.5, color=meanLat))+
  geom_point(alpha = 0.5)
print(PM2.5year_1)

EPAair$Year <- as.factor(EPAair$Year)

PM2.5year_2 <- ggplot(EPAair, aes(x=Year, y=PM2.5, color=meanLat))+
