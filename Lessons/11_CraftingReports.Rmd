...
### dataset name + relevant dataset info (e.g. EPA air pollutants + provides measurements on ozone & PM concentrations) -- include 4 examples & that should be good
...
```{r}
tn_time_display <- ggplot(Nutr_filtered, (aes(x=sampledate, y=tn_ug)))+
    geom_point()+
    facet_wrap(vars(lakename), nrow = 4)+
    labs(x = "Time", y = "Total Nitrogen Concentration (ug)")
tn_time_display
...
Text text, paragraph to include. Text text, paragraph to include.Text text, paragraph to include. Text text, paragraph to include. Text text, paragraph to include. Text text, paragraph to include. Text text, paragraph to include.


*****

Text again, let's see if it works.
