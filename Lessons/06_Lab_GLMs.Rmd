...
Alternative hypothesis (Ha) is that ozone layers are below the threshold for "good" AQI index (0-50). H0: mu >=50; Ha: mu < 50
...
## Ozone and Site Latitude show the highest correlation to PM2.5 in the correlation plot display.
...
## These results recommend including Site Longitude and Month, as well as Site Latitude and Ozone. Longitude and Month showed less influence, yet still resulted in lower AIC values. 
...
OzoneByAIG_regression <- lm(data = EPAair_subset, PM2.5 ~ Ozone + SITE_LATITUDE + Month + SITE_LONGITUDE)
