...
## another method -- both give the same output
mapView(list(huc8_sf, huc8_UpperNeuse_sf), col.regions = list("orange", "purple"))
...
huc2_sf <- huc8_sf %>% ### renamed from DWQ_Basin_sf to huc2_sf to match code below
  group_by(DWQ_Basin) %>%
